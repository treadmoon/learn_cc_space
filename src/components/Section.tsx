...
export function Section({ title, titleClass, icon, count, defaultOpen = true, children }: Props) {
    return (
        <details open={defaultOpen} className="group/section">
            <summary className="flex items-center gap-2 px-4 py-2.5 cursor-pointer select-none hover:bg-white/[0.02] transition-colors list-none [&::-webkit-details-marker]:hidden">
